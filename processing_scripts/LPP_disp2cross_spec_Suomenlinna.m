...
Fn.up=sprintf('netcdf/up_NR_%s%.0f_%s.nc',loc,yyyy,run_index); 
Fn.east=sprintf('netcdf/east_NR_%s%.0f_%s.nc',loc,yyyy,run_index); 
Fn.north=sprintf('netcdf/north_NR_%s%.0f_%s.nc',loc,yyyy,run_index); 
